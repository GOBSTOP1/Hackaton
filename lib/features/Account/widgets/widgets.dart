      ...
      children: <Widget>[
        ...
        ListTile(
          ...
          trailing: IconButton(onPressed: (){}, icon: const Icon(Icons.arrow_forward),),
           contentPadding: const EdgeInsets.all(20.0), // Увеличиваем отступы вокруг содержимого
  dense: true, // Уменьшаем вертикальные отступы
        ),
        ListTile(
          title: IconButton(onPressed: () => signOut(), icon:const Icon(Icons.exit_to_app)),
          trailing: IconButton(onPressed: () => MenuRepository().loadMenu(), icon: const Icon(Icons.download),),
        ),
        ListTile(
        ...
        ListTile(
          title: Text('Организация',style: theme.textTheme.bodyMedium,),
          trailing: const Icon(Icons.arrow_forward),
          onTap: (){Navigator.pushNamed(context, '/organisationChose');},
        ),
      ],
    );
  }
